...
namespace PluginSageIntacct.API.Utility.EndpointHelperEndpoints
{
    ...
    public class ItemsEndpointHelper
    {
        
        private class ItemsEndpoint : Endpoint
        {
            

        }

        public static readonly Dictionary<string, Endpoint> ItemsEndpoints = new Dictionary<string, Endpoint>
        {
            {
                "AllItems", new ItemsEndpoint
                {
                    Id = "AllItems",
                    Name = "All Items",
                    LookupObject = "ITEM",
