...
namespace PluginSageIntacct.API.Utility.EndpointHelperEndpoints
{
    ...
    public class InvoicesEndpointHelper
    {
        
        private class InvoicesEndpoint : Endpoint
        {
            

        }

        public static readonly Dictionary<string, Endpoint> InvoicesEndpoints = new Dictionary<string, Endpoint>
        {
            {
                "AllInvoices", new InvoicesEndpoint
                {
                    Id = "AllInvoices",
                    Name = "All Invoices",
                    LookupObject = "ARINVOICE",
