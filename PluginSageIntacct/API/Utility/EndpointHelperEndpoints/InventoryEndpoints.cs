...
namespace PluginSageIntacct.API.Utility.EndpointHelperEndpoints
{
    ...
    public class InventoryEndpointHelper
    {
        
        private class InventoryEndpoint : Endpoint
        {
            

        }

        public static readonly Dictionary<string, Endpoint> InventoryEndpoints = new Dictionary<string, Endpoint>
        {
            {
                "AllInventory", new InventoryEndpoint
                {
                    Id = "AllInventory",
                    Name = "All Inventory",
                    LookupObject = "AVAILABLEINVENTORY",
