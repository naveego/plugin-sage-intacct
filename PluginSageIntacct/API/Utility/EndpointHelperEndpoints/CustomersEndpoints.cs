...
namespace PluginSageIntacct.API.Utility.EndpointHelperEndpoints
{
    ...
    public class CustomersEndpointHelper
    {
        
        private class CustomersEndpoint : Endpoint
        {
            

        }

        public static readonly Dictionary<string, Endpoint> CustomersEndpoints = new Dictionary<string, Endpoint>
        {
            {
                "AllCustomers", new CustomersEndpoint
                {
                    Id = "AllCustomers",
                    Name = "All Customers",
